...
class ReportAdmin(admin.ModelAdmin):
    ...
    def ajax_starred(self, obj):
        ...
        return mark_safe('<a href="javascript:void(0)" onclick="ajax_add_star(this, \'{}\')"><img style="width: 26px; margin: -6px;" src="{}"/></a>'.format(
...
def export_to_report(modeladmin, request, queryset):
    ...
    return HttpResponseRedirect(reverse('export_to_report') + "?ct={}&admin_url={}&ids={}".format(ct.pk, admin_url, ",".join(selected)))
